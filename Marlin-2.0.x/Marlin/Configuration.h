...
#define STRING_CONFIG_H_AUTHOR "Salty, B1-E3D)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Dicks B1"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 414.2}
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48.3, 30.4, -4.61 }
